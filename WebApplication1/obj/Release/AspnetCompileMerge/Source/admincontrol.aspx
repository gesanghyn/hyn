...
<body>
    ...
    <div class="page" style="margin-left: 10%; width: 600px; ">
        <form runat="server">
            ...
            <br />
            <div class="thcss">
                <table class="table-thead " style="width: 77.97%">
                    <colgroup>
                        <col width="133px">
                        <col width="273px">
                        <col width="378px">
