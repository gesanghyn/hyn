    ...
    <div class="page" style="margin-left: 10%; width: 600px; ">
            ...
            <div class="auto-style1">
                <div class="containers">
                    <div class="auto-style3">
                        <br />
                        <asp:Label ID="Label1" runat="server" CssClass="tips"></asp:Label>
                        <br />
                        <br />
                        ...
                        <asp:Button ID="Button1" class="button button2" runat="server" Text="查看日志" Width="128px" Height="50px" OnClick="Button1_Click" />
                        <asp:Button ID="Button11" class="button button5" Width="133px" Height="50px" runat="server" Text="提交日志" OnClick="Button11_Click" />
		...
		<span class="caret"></span>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li>
                                    <asp:Button ID="Button5" runat="server" Text="历史记录" class="button button4" OnClick="Button5_Click" />
                                </li>
                            </ul>
                        </div>
