<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="admincontrol.aspx.cs" Inherits="WebApplication1.admincontrol" %>
        ...
        <form runat="server">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="admincontrol.aspx" class="liactive">员工管理</a></li>
            ...
            <br />
            <div class="thcss"> 
                <table class="table-thead " Width="1402px">
                    <thead>
                        <tr>
                            <th width="148.86px">序号</th>
                            <th width="270px">用户名</th>
                            <th width="388.94px">密码</th>
                            <th width="227px"> 身份属性</th>
                            <th  width="204px">编辑</th>
                            <th width="152px">删除</th>
                        </tr>
                    </thead>
                </table>
            </div>
            <div class="auto-style1" onscroll="javascript:RecordPostion(this);"  id="dvGridView">
                <asp:GridView ID="GridView1" HorizontalAlign="Center" Width="1400px" CssClass="GridView" runat="server" AutoGenerateColumns="False" Height="239px" OnRowEditing="GridView1_RowEditing1" DataKeyNames="userName" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowUpdating="GridView1_RowUpdating1" OnRowDataBound="GridView1_RowDataBound" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting" BorderColor="Silver" BorderStyle="Solid">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:BoundField HeaderText="序号">
                         <ItemStyle Width="148.86px"/>
                        </asp:BoundField>
                        ...
                        <asp:BoundField HeaderText="密码" DataField="password">
                            <ItemStyle Width="388.94px"/>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="身份属性" DataField="identity">
                            <ItemStyle Width="227px"/>
                        </asp:BoundField>
                        <asp:CommandField HeaderText="编辑" ShowDeleteButton="True" ShowEditButton="True" ShowHeader="True" ShowSelectButton="True" DeleteText="" SelectText="">
                    ...
                    <FooterStyle BorderColor="Gainsboro" BorderStyle="Solid" />
                    <HeaderStyle BorderColor="Gainsboro" BorderStyle="solid"  CssClass="topstyle"/>
                    <RowStyle BorderStyle="Solid" BorderColor="Gainsboro" />
                </asp:GridView>
