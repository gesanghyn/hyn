<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="historylook.aspx.cs" Inherits="WebApplication1.historylook" %>
        ...
        <form runat="server">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li class="liactive"><a href="historylook.aspx">历史记录</a></li>
